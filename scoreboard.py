...
class Scoreboard:
    ...
    def check_high_score(self):
        ...
        if self.stats.score > self.stats.high_score:
            ...
            # Guarda la puntuacion maxima en el archivo high_score.tx
            with open(self.settings.high_score_txt, 'w') as file_objetc:
                file_objetc.write(str(self.stats.high_score))
